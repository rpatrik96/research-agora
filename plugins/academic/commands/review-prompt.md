...
- **User asks why prompting matters**: "The Research Agora's skills are structured prompts. The difference between a skill and an ad-hoc prompt is that the skill has all six components specified. That's why skills produce consistent, verifiable output and ad-hoc prompts produce whatever the AI felt like."
